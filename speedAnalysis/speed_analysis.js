let textTest = "The quick brown fox jumps over the lazy dog.";
let startTime, endTime;

function startTest(){
    // set the test text
    document.getElementById("inputText").value = textTest;
...
function endTest(){
    ...
    var userTypeText = document.getElementById("inputText").value;
